...
**Max 20x = $200/월 — 연구개발본부 전원 제공은 비용 부담 큼**

따라서 다음과 같은 **3단계 도입안**을 제안드립니다.

**1단계 — 의사결정권자 6명 + 발표자 1명에게 Max 우선 제공**

- 팀장님 5분 + 전무님 1분 = **총 6명** (의사결정권자)
- 의사결정권자가 직접 체감해야 **조직 차원 투자 판단**이 가능
- 소수 집중 투자로 **초기 비용 통제**
- <span style="color:#c0392b;">**+ 발표자 1명** — 이미 2개월째 Max 를 열심히 쓰는 중이라 빼면 섭섭합니다 😅</span>

<!-- timing: 45 -->

---

# 도입 제안 ② — Pro 부터 시작, 실사용자만 승격

**2단계 — 나머지 팀원에게는 Pro 부터 시작**

- 토큰 사용 감각에 익숙하지 않을 수 있음 → **가벼운 진입**
- Pro 한도 내에서 해결되는 업무도 많음

**3단계 — Pro 한도를 5회 소진하면 Max 로 승격**

- 사용 패턴으로 **heavy user 임이 증명된 사람만 Max**
- "Usage-based promotion" — 필요한 사람에게만 Max 비용 투입
- 낭비 없이 실수요자에게 리소스 집중, **ROI 근거 확보**

<span class="qualifier">개인 제안 — 실제 도입 방식은 본부 차원 논의 필요</span>
